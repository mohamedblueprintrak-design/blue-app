...
async function fetchContextData(topics: string[], userRole: string, userId?: string, projectId?: string, organizationId?: string | null) {
...
async function fetchProjectContext(projectId: string, ctx: AuthContext): Promise<string | null> {
