 ...
 * قوالب مراحل سير العمل
 * 
 * Architectural & Contract Workflow Phase Templates for government approval workflows.
 */

import { type WorkflowPhaseTemplateData } from './types';
